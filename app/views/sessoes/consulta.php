  ...
  <div class='row'>
    ...
    <div class='col-sm-8 col-lg-6'>
      <form action="<?php echo URLROOT;?>/sessoes/pesquisa" method="post">
        <div class='row'>
          <div class='col-10'>
            <select class='custom-select' name='tipo_pesquisa'>
                <option selected>Pesquise por...</option>
                <option>Cliente</option>
                <option>Data</option>
                <option>Clinica</option>
            </select>
            <input type='text' name='texto_pesquisa' placeholder="Escolha uma forma de pesquisa" class='form-control pr-0 mt-1' readonly>
          </div>
